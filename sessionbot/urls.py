...
from .views import bulk_campaign, createProxyResource, createResource, createDeviceResource, deleteDeviceResource, deleteProxyResource, attendance_task
...
urlpatterns = [
    ...
    path('api/scrape-task/create/', views.scrape_task, name='scrape_task'),
]